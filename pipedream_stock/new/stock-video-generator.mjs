...
export default defineComponent({
  name: "Stock Video Generator",
  description: "Shorts 대본으로 씬별 이미지 + 비디오 생성 (Imagen + Veo 3.0)",
  ...
  props: {
    ...
    custom_image_urls: {
      type: "string",
      label: "커스텀 이미지 URL (JSON)",
      description: '씬별 이미지 URL을 JSON으로 입력. 예: {"1":"https://...", "2":"https://..."} 또는 모든 씬에 동일 이미지: "https://..."',
      optional: true,
    },
  ...
  async run({ $ }) {
    ...
    let data;
    try {
      data = typeof this.shorts_script_output === "string"
        ? JSON.parse(this.shorts_script_output) : this.shorts_script_output;
    } catch (e) {
