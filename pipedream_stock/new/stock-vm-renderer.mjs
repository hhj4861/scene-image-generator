...
export default defineComponent({
  name: "Stock VM Renderer",
  description: "FFmpeg VM을 이용한 주식 뉴스 영상 합성 (비디오 + BGM)",
  ...
  async run({ $ }) {
    ...
    try {
      data = typeof this.video_generation_output === "string"
        ? JSON.parse(this.video_generation_output)
        : this.video_generation_output;
    } catch (e) {
    ...
    console.log(`🎬 Stock VM Renderer 시작`);
